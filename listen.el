...
;; Keywords: multimedia
;; Package-Requires: ((emacs "29.1") (persist "0.6") (taxy "0.10") (taxy-magit-section "0.13") (transient "0.5.3") (plz "0.9") (svg-lib "0.3"))
;; Version: 0.10-pre
  ...
  [["Queue mode"
   ...
   ["Add tracks"
    ...
    ("qap" "from playlist file" listen-queue-add-from-playlist-file
     :transient t)]
   ["Subsonic"
    ("qvs" "from Subsonic" listen-queue-add-from-subsonic
     :transient t)
